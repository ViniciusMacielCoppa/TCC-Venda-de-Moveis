...
<head>
    ...
    <title>MARdeira | Móveis Pedidos</title>
</head>
                    ...
                    <div class="ficar_pedidos">
                        ...
                        <div class="todos_pedidos">
                            <?php
                                ...
                                ON U.user_id = P.user_id INNER JOIN Moveis M ON M.movel_id = P.pedido_referencia WHERE U.user_id = $id ORDER BY pedido_id DESC";
